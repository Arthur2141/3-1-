...
// 更新処理
void SceneGame04::Update(float elapsedTime)
{
	// カメラコントローラー更新処理
...
void SceneGame04::RenderReflect()
{
	Graphics& graphics = Graphics::Instance();
	ID3D11DeviceContext* dc = graphics.GetDeviceContext();
...
// エネミーHPゲージ描画
void SceneGame04::RenderEnemyGauge(
