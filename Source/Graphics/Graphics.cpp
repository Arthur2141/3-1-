...
#include "Graphics/PhongDrawShadowShader.h"
#include "Graphics/NoLightShader.h"
#include "Graphics/WaterSurfaceShader.h"
//#include "Graphics/WaterSurfaceShader2.h"
#include "Graphics/ReflectMapShader.h"
#include "Graphics/WaterSurfaceRipplesShader.h"
#include "Graphics/MakeCubeMapShader.h"
#include "Graphics/UseCubeMapShader.h"
#include "Graphics/PhongDistructShader.h"
...
Graphics::Graphics(HWND hWnd)
{
	...
	// シェーダー
	{
		shader[static_cast<int>(ShaderType::LambertShader)] = std::make_unique<LambertShader>(device.Get());
		shader[static_cast<int>(ShaderType::PhongShader)] = std::make_unique<PhongShader>(device.Get());
		shader[static_cast<int>(ShaderType::ToonShader)] = std::make_unique<ToonShader>(device.Get());
		shader[static_cast<int>(ShaderType::ShadowMapShader)] = std::make_unique<ShadowMapShader>(device.Get());
		shader[static_cast<int>(ShaderType::PhongDrawShadowShader)] = std::make_unique<PhongDrawShadowShader>(device.Get());
		shader[static_cast<int>(ShaderType::NoLightShader)] = std::make_unique<NoLightShader>(device.Get());
